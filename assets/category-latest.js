(function(){
  ...
  style.textContent='.cln{max-width:1240px;margin:72px auto 0;padding:0 24px 64px}.cln-h{display:flex;align-items:center;gap:18px;margin-bottom:18px}.cln-h h2{font:700 25px/1.2 var(--fd,Arial);margin:0;color:var(--white,#f3efff)}.cln-h h2 em{color:var(--cyan,#00e5ff);font-style:normal}.cln-line{height:1px;background:rgba(0,229,255,.25);flex:1}.cln-all{color:var(--muted,#8d849c);text-decoration:none;font-size:12px}.cln-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:3px}.cln-card{background:var(--surf,#150a2c);color:var(--white,#f3efff);text-decoration:none;border:1px solid rgba(255,255,255,.08);min-width:0;overflow:hidden}.cln-card img{width:100%!important;height:auto!important;aspect-ratio:16/9!important;object-fit:cover!important;object-position:center!important;display:block!important}.cln-copy{padding:14px}.cln-cat{color:var(--sakura,#ff3080);font-size:10px;letter-spacing:.16em;text-transform:uppercase}.cln-title{font:700 17px/1.35 var(--fd,Arial);margin-top:7px}.cln-card:hover .cln-title{color:var(--cyan,#00e5ff)}@media(max-width:900px){.cln{margin-top:48px}.cln-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:520px){.cln{padding:0 14px 42px}.cln-h{gap:10px}.cln-h h2{font-size:21px}.cln-grid{display:flex;overflow-x:auto;scroll-snap-type:x mandatory}.cln-card{min-width:82%;scroll-snap-align:start}}';
  document.head.appendChild(style);
  var section=document.createElement('section');section.className='cln cln-'+category;
